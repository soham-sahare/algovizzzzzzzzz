...
const jumpSearchCode = `function jumpSearch(arr, x, n):
  step = sqrt(n)
  prev = 0
...
export default function JumpSearchPage() {
    ...
    const handleSearch = () => {
        ...
        const generator = generateJumpSearchSteps(array, t);
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex justify-between items-center">
                <div>
                     <h1 className="text-3xl font-bold text-foreground mb-2">Jump Search</h1>
                     <p className="text-muted-foreground">Optimal for Sorted Arrays. Jumps ahead by fixed steps (√n) then performs linear search.</p>
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                     <CodeHighlight code={jumpSearchCode} activeLine={stepData.lineNumber} />
                      ...
                      <div className="bg-zinc-50 dark:bg-zinc-900/30 p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span className="font-mono bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 px-2 py-0.5 rounded">O(√n)</span>
                                </div>
                                <div>
