...
export default function QuickSortPage() {
  ...
  const generateRandomArray = () => {
    ...
    setArray(newArray);
    const generator = generateQuickSortSteps(newArray);
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           <h1 className="text-3xl font-bold text-foreground mb-2">Quick Sort Visualization</h1>
           <p className="text-muted-foreground">Efficient divide-and-conquer algorithm that selects a 'pivot' element and partitions the array around it.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
            <div>
                ...
                <CodeHighlight code={quickSortCode} activeLine={currentStepData.lineNumber} />
            </div>
