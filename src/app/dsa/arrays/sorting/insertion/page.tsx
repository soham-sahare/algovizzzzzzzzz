...
const insertionSortCode = `for i = 1 to n-1
  key = arr[i]
  j = i - 1
...
export default function InsertionSortPage() {
  ...
  const generateRandomArray = () => {
    ...
    setArray(newArray);
    const generator = generateInsertionSortSteps(newArray);
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           <h1 className="text-3xl font-bold text-foreground mb-2">Insertion Sort Visualization</h1>
           <p className="text-muted-foreground">Builds the sorted array one item at a time, picking the next element and inserting it into the correct position.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
            <div>
                ...
                <CodeHighlight code={insertionSortCode} activeLine={currentStepData.lineNumber} />
            </div>
