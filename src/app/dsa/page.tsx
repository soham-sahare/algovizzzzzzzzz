...
const categories = [
  ...
  { name: "Trees", description: "Binary trees, BST, AVL, heaps, traversals.", icon: <Trees />, href: "/dsa/trees" },
  { name: "Tries", description: "Prefix trees for efficient string searching and storage.", icon: <Network />, href: "/dsa/tries" },
