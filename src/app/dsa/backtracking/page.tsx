...
const backtrackingImplementations = [
  { 
      name: "N-Queens Problem", 
      description: "Place N queens on an NxN chessboard so that no two queens attack each other.", 
      icon: <Crown className="w-6 h-6" />, 
      href: "/dsa/backtracking/n-queens" 
  },
  { 
      name: "Sudoku Solver", 
      description: "Fill a 9x9 grid with digits so that each column, row, and subgrid contains all digits.", 
    ...
    <div className="min-h-screen px-4 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {backtrackingImplementations.map((impl, index) => (
            <motion.div
              key={impl.name}
