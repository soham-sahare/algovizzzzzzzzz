...
const stackImplementations = [
  { 
      name: "Array-Based Stack", 
      description: "Implemented using a fixed-size array. Demonstrates Overflow/Underflow clearly.", 
      icon: <Layers className="w-6 h-6" />, 
      href: "/dsa/stacks/array" 
  },
  { 
      name: "Linked List-Based Stack", 
      description: "Implemented using a dynamic linked list. No fixed capacity limit (until memory runs out).", 
      icon: <GitBranch className="w-6 h-6" />, 
      href: "/dsa/stacks/linked-list" 
  },
  {
      name: "Balanced Parentheses",
      description: "Visualizes stack usage for checking bracket balance.",
      icon: <Layers className="w-6 h-6" />,
      href: "/dsa/stacks/challenges/parentheses"
  },
  {
      name: "Reverse String",
      description: "Simple application of Stack LIFO property.",
      icon: <Layers className="w-6 h-6" />,
      href: "/dsa/stacks/challenges/reverse-string"
  },
  {
      name: "Next Greater Element",
      description: "Monotonic Stack algorithm visualization.",
      icon: <Layers className="w-6 h-6" />,
      href: "/dsa/stacks/challenges/monotonic"
  }
];
    ...
    <div className="min-h-screen px-4 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {stackImplementations.map((impl, index) => (
            <motion.div
              key={impl.name}
